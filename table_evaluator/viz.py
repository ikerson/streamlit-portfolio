...
def plot_var_cor(x: Union[pd.DataFrame, np.ndarray], ax=None, return_values: bool = False, rplt = False, **kwargs) -> Optional[np.ndarray]:
    """
...
def plot_correlation_difference(real: pd.DataFrame, fake: pd.DataFrame, plot_diff: bool = True, cat_cols: list = None, annot=False, fname=None, rplt = False):
    """
...
def plot_correlation_comparison(evaluators: List, annot=False, rplt=False):
    """
...
def plot_mean_std_comparison(evaluators: List, rplt = False):
    """
...
def plot_mean_std(real: pd.DataFrame, fake: pd.DataFrame, ax=None, fname=None, rplt=False):
    """
